...
- A `null` value (e.g. "sma200": null, "above_sma200": null) means that figure is NOT AVAILABLE for this stock (typically insufficient price history) — it is NOT the same as false/zero/below. NEVER state or imply a comparison against a null figure (e.g. never say price is "below its 200-day average" when sma200/above_sma200 is null); say plainly that figure isn't available instead.
